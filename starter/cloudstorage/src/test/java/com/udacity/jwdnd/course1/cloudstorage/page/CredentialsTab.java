...
public class CredentialsTab {
  ...
  public void editCredentialModal(WebDriver driver) {
    ...
    WebElement webElement =
        credentialTable.findElement(By.xpath("//*[@id='credentialTable']/tbody/tr/td[1]/button"));
  ...
  public boolean isPasswordEncrypted() {
    ...
    WebElement credential =
        credentialTable.findElement(By.xpath("//*[@id='credentialTable']/tbody[1]/tr/td[3]"));
    return !(credential.getAttribute("textContent").equalsIgnoreCase("chatPassword"));
  }

  public void deleteCredential(WebDriver driver) {
    WebElement element =
        credentialTable.findElement(By.xpath("//*[@id='credentialTable']/tbody[1]/tr/td[1]/a"));
